...
- **Treino** (`js/training.js` `checkCoinDropsForDistance`): a cada quilómetro **real** (GPS — encontrar moedas é sobre esforço físico bruto, não sobre o modo) percorrido, 50% de chance de encontrar entre 1 e 20 moedas. Testado exatamente uma vez por km inteiro cruzado (nunca duas vezes pelo mesmo km, mesmo que um segmento de GPS avance mais que 1km de uma vez).
