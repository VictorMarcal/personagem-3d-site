...
- Relatórios de batalha (Eu › Troféus, `#horde-reports-list`): cada horda repelida grava `{ data, numero, resultado: "vitoria"|"derrota", recursosRoubadosPorRecurso }` em `STORAGE_KEY_HORDE_REPORTS` (últimas 20, mais recente primeiro) — "derrota" usa o mesmo critério do saque (`hordaRouboJaAconteceu`).
