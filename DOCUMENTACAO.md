...
- `descobre_hex` passa a mostrar o progresso ("N / M hexágonos") a subir ao vivo (só as de distância o faziam). `verificarMinas` (`js/resources.js`) chama `verificarMissaoAtiva()` ao encontrar um depósito, para "encontra um depósito de X" fechar no momento.
